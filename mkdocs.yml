...
nav:
  ...
  - Introduction: 
          ...
          - Kalp blockchain: 'Introduction/Kalp-blockchain.md'
  - Getting started:
      - Onboarding:
      ...
      - Wallets:
          - How to Navigate To Wallet: 'Getting-started/Wallets/How-to-Navigate-To-Wallet.md'
          - How to Create and Connect Wallet to Kalp Studio: 'Getting-started/Wallets/How-to-Create-and-Connect-Wallet-to-Kalp-Studio.md'
      ...
      - Settings:
          - How to Customize Notifications KYC and Templates: 'Getting-started/Settings/How-to-Customize-Notifications-KYC-and-Templates.md'
  - Dev documentation:
      - Use the kalp SDK:
...
extra:
  social:
    ...
    - icon: fontawesome/brands/github
      link: https://github.com/p2eengineering/kalp-studio-documentation
